    ...
    <Sheet>
      ...
      >
        ...
        >
          <Input
            type='text'
            className='text-3xl focus-visible:outline-none focus-visible:ring-0 focus-visible:border-none sm:text-5xl mb-4 sm:mb-8 font-bold w-3/4 outline-none border-none p-0'
            value={invoiceId}
